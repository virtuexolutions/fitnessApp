      ...
      <View
        ...
        <View style={styles.infoBox}>
          <CustomText style={styles.heading} isBold>
            How often did you have frozen ready meals last week?
          </CustomText>
          <CustomText style={styles.examples}>
            e.g. pizza, pot pie, empanadas, chicken alfredo
          </CustomText>
        </View>
        <View style={styles.limitBox}>
          ...
          <CustomButton
            ...
            onPress={() => {
              navigationService.navigate('QuestionnaireRice');
              dispatch(setTestData({frozenMealsLastWeek: sliderValue}));
            }}
          />
        </View>
      </View>
...
export default QuestionnaireFrozenMeals;
