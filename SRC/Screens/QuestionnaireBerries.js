...
const QuestionnaireBerries = () => {
 ...
 imageStyle={{width: '100%', height: '100%'}}>
  ...
  />
    ...
    <CustomText style={[styles.duration,{color:Color.white, width: windowWidth, marginTop:moderateScale(12,0.3)}]} isBold>4/41</CustomText>
    </View>
...
<View style={styles.infoBox}>
 ...
 How often did you have berries last week?
 </CustomText>
 <CustomText style={styles.examples}>
 e.g. strawberries, blueberries, frozen raspberries
 </CustomText>
</View>
...
export default QuestionnaireBerries
