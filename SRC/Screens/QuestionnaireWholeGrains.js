...
const QuestionnaireWholeGrains = () => {
  const [sliderValue, setSliderValue] = useState(0);
  const testData = useSelector(state => state.commonReducer.testData);
  console.log('🚀 ~ QuestionnaireCandy ~ testData:', testData);
      ...
      <View
        ...
        <View style={styles.infoBox}>
          <CustomText style={styles.heading} isBold>
            How often did you have other whole grains last week?
          </CustomText>
          <CustomText style={styles.examples}>
            e.g. quinoa, whole grain bulgur, amaranth, buckwheat, barley, farro
          </CustomText>
        </View>
        <View style={styles.limitBox}>
          ...
          <CustomButton
            ...
            onPress={() => {
              navigationService.navigate('QuestionnairePastaNoodles');
              dispatch(
                setTestData({
                  wholeGrainLastWeek: sliderValue,
                }),
              );
            }}
          />
...
export default QuestionnaireWholeGrains;
