...
const QuestionnaireCandy = () => {
 ...
 imageStyle={{width: '100%', height: '100%'}}>
  <View style={styles.topRoundImageContainer}>
        <CustomImage
          style={{width: '100%'}}
          source={require('../Assets/Images/oatmeals.png')}
...
<View>
 ...
 <CustomImage
    ...
    <CustomText style={[styles.duration,{color:Color.white, width: windowWidth, marginTop:moderateScale(12,0.3)}]} isBold>31/41</CustomText>
    </View>
...
<View style={styles.infoBox}>
 ...
 How often did you eat candy or chocolate last week?
 </CustomText>
 <CustomText style={styles.examples}>
 e.g. gummy candy, lollipops, milk, dark & white chocolate
 </CustomText>
</View>
...
export default QuestionnaireCandy;
