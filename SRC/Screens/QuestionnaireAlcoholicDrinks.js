...
const QuestionnaireAlcoholicDrinks = () => {
  return (
    <ImageBackground
      ...
      <View
        ...
        <View style={styles.limitBox}>
          <CustomText style={styles.duration}>9-11 drinks a week</CustomText>
          ...
          <CustomButton
            ...
            onPress={() => navigationService.navigate('QuestionnaireYogurt')}
          />
        </View>
      </View>
    </ImageBackground>
...
export default QuestionnaireAlcoholicDrinks;
