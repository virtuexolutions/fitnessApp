...
const QuestionnairePastaNoodles = () => {
  return (
 <ImageBackground
 ...
 <CustomImage
    ...
    <CustomText style={[styles.duration,{color:Color.white, width: windowWidth, marginTop:moderateScale(12,0.3)}]} isBold>24/41</CustomText>
    </View>
    <View
...
<View style={styles.infoBox}>
 ...
 How often did you have pasta or noodles last week?
 </CustomText>
 <CustomText style={styles.examples}>
 e.g. spagetti, whole grain penne, ravioli, udon, egg noodles, vermicelli
 </CustomText>
</View>
...
export default QuestionnairePastaNoodles
