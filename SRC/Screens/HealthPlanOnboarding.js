...
<View style={styles.content}>
    <CustomText style={styles.headingText} isBold>We're Setting Everything Up For You</CustomText>
    <CustomText style={styles.subHeadingText}>Customizing Your Health Plan.....</CustomText>
    <CustomButton
            onPress={() => {
