      ...
      <View
        ...
        <View style={styles.infoBox}>
          <CustomText style={styles.heading} isBold>
            How often did you have fruit juice last week?
          </CustomText>
          <CustomText style={styles.examples}>
            e.g. orange juice, apple juice
          </CustomText>
        </View>
        <View style={styles.limitBox}>
          ...
          <CustomButton
            ...
            onPress={() => {
              navigationService.navigate('QuestionnaireMeat');
              dispatch(setTestData({fruitJuiceLastWeek: sliderValue}));
            }}
          />
        </View>
      </View>
...
export default QuestionnaireFruitJuice;
