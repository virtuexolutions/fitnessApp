      ...
      <View
        ...
        <View style={styles.infoBox}>
          <CustomText style={styles.heading} isBold>
            How often did you have cereal with added sugar last week?
          </CustomText>
          <CustomText style={styles.examples}>
            e.g. Cheerios, Special K, Bran Flakes, Fruit Loops, sweetened or
            flavored oatmeal
          </CustomText>
        </View>
        <View style={styles.limitBox}>
          ...
          <CustomButton
            ...
            onPress={() => {
              navigationService.navigate('QuestionnaireCandy');
              dispatch(setTestData({ceralWithSugerLastWeek: sliderValue}));
            }}
          />
        </View>
      </View>
...
export default QuestionnaireCereal;
