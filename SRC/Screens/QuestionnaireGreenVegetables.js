...
const QuestionnaireGreenVegetables = () => {
      ...
      <View
        ...
        <View style={styles.infoBox}>
          <CustomText style={styles.heading} isBold>
            How often did you have green, leafy vegetables last week?
          </CustomText>
          <CustomText style={styles.examples}>
            e.g. spinach, arugula, kale, celery
          </CustomText>
        </View>
        <View style={styles.limitBox}>
          ...
          <CustomButton
            ...
            onPress={() => {
              navigationService.navigate('QuestionnaireRootVegetables');
              dispatch(
                setTestData({
                  leafyVegetablesLastWeek: sliderValue,
                }),
              );
            }}
          />
...
export default QuestionnaireGreenVegetables;
