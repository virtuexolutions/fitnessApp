      ...
      <View
        ...
        <View style={styles.infoBox}>
          <CustomText style={styles.heading} isBold>
            How much of that bread was whole grain?
          </CustomText>
          <CustomText style={styles.examples}>
            e.g. multigrain sliced bread, whole wheat buns
          </CustomText>
        </View>
        <View style={styles.limitBox}>
          ...
          <CustomButton
            ...
            onPress={() => {
              navigationService.navigate('QuestionnaireCereal');
              dispatch(setTestData({breadWholeGrain: sliderValue}));
            }}
          />
        </View>
      </View>
...
export default QuestionnaireBread2;
