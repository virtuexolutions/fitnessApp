      ...
      <View
        ...
        <View style={styles.infoBox}>
          <CustomText style={styles.heading} isBold>
            How often did you have vegetarian or plant-based protein last week?
          </CustomText>
          <CustomText style={styles.examples}>
            e.g. tofu, tempeh, lentils, soy products, black beans, chickpeas,
            Beyond burger
          </CustomText>
        </View>
        <View style={styles.limitBox}>
          ...
          <CustomButton
            ...
            onPress={() => {
              navigationService.navigate('QuestionnaireAlcoholicDrinks');
              dispatch(setTestData({protienLastWeek: sliderValue}));
            }}
          />
        </View>
      </View>
...
export default QuestionnaireProtien;
