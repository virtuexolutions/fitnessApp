      ...
      <View
        ...
        <View style={styles.infoBox}>
          <CustomText style={styles.heading} isBold>
            How often did you have fish or seafood last week?
          </CustomText>
          <CustomText style={styles.examples}>
            e.g. salmon, cod, shrimp, canned tuna
          </CustomText>
        </View>
        <View style={styles.limitBox}>
          ...
          <CustomButton
            ...
            onPress={() => {
              navigationService.navigate('QuestionnaireSeeds');
              dispatch(setTestData({seaFoodLastWeek: sliderValue}));
            }}
          />
        </View>
      </View>
...
export default QuestionnaireSeaFood;
