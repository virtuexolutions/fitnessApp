...
const QuestionnaireRootVegetables = () => {
      ...
      <View
        ...
        <View style={styles.infoBox}>
          <CustomText style={styles.heading} isBold>
            How often did you have root vegetables last week?
          </CustomText>
          <CustomText style={styles.examples}>
            e.g. carrots, beets, parsnips
          </CustomText>
        </View>
        <View style={styles.limitBox}>
          ...
          <CustomButton
            ...
            onPress={() => {
              navigationService.navigate('QuestionnaireSeaFood');
              dispatch(setTestData({rootVegetablesLastWeek: sliderValue}));
            }}
          />
        </View>
      </View>
...
export default QuestionnaireRootVegetables;
