      ...
      <View
        ...
        <View style={styles.infoBox}>
          <CustomText style={styles.heading} isBold>
            How often did you have plain shredded wheat or oatmeal last week?
          </CustomText>
          <CustomText style={styles.examples}>
            don't count sweetened or flavored oatmeal
          </CustomText>
        </View>
        <View style={styles.limitBox}>
          ...
          <CustomButton
            ...
            onPress={() => {
              navigationService.navigate('QuestionnaireBerries');
              dispatch(
                setTestData({
                  oatMealLastWeek: sliderValue,
                }),
              );
            }}
          />
...
export default QuestionnaireOatMeals;

const styles = StyleSheet.create({
  bgcImageStyle: {
    width: windowWidth,
    height: windowHeight,
    // gap:moderateScale(100,0.2),
