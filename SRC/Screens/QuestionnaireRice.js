      ...
      <View
        ...
        <View style={styles.infoBox}>
          <CustomText style={styles.heading} isBold>
            How often did you have rice last week?
          </CustomText>
          <CustomText style={styles.examples}>
            e.g. long grain, basmati, jasmine, sushi rice, thai sticky rice,
            brown rice
          </CustomText>
        </View>
        <View style={styles.limitBox}>
          ...
          <CustomButton
            ...
            onPress={() => {
              navigationService.navigate('QuestionnaireSaltySnacks');
              dispatch(setTestData({riceLastWeek: sliderValue}));
            }}
          />
        </View>
      </View>
...
export default QuestionnaireRice;
