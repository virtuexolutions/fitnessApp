      ...
      <View
        ...
        <View style={styles.infoBox}>
          <CustomText style={styles.heading} isBold>
            How often did you have whole fruit last week?
          </CustomText>
          <CustomText style={styles.examples}>
            e.g. bananas, watermelon, frozen mango don't count dried fruit or
            berries
          </CustomText>
        </View>
...
5-6 glasses a day
          ...
          <CustomButton
            ...
            onPress={() => {
              navigationService.navigate('QuestionnaireWholeGrainRice');
              dispatch(
                setTestData({
                  FruitsLastWeek: sliderValue,
                }),
              );
            }}
          />
...
export default QuestionnaireFruit;
