      ...
      <View
        ...
        <View style={styles.infoBox}>
          <CustomText style={styles.heading} isBold>
            How often did you have flavored yogurt with added sugar last week?
          </CustomText>
          <CustomText style={styles.examples}>
            e.g. strawberry yogurt, peach yogurt, yogurt with honey
          </CustomText>
        </View>
        <View style={styles.limitBox}>
          ...
          <CustomButton
            ...
            onPress={() => {
              navigationService.navigate('QuestionnaireEggs');
              dispatch(setTestData({yougurtLastWeek: sliderValue}));
            }}
          />
        </View>
      </View>
...
export default QuestionnaireYogurt;
